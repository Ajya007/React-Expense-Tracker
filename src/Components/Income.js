    ...
    return(
        <div className="income" >
            <form onSubmit={incomeSubmitHandler}>
                <input onChange={(e) => setIncomeTitle(e.target.value)} placeholder="Add Income" value={incomeTitle}/>
                <input onChange={(e) => setIncomeValue(e.target.value)}  value={incomeValue} />
